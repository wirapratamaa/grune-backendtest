$(function () {
    ...
    $('li#menu-companies').find('.treeview').css('display', 'block');
    ...
    $("#datalist").tabulator({
        ...
        columns: [
            {title: "ID", field: "id", width: 50, headerFilter: "input", sorter: "number", headerFilterPlaceholder: " "},
            {title: "Name", field: "name", minwidth: 100, headerFilter: "input", headerFilterPlaceholder: " "},
            ...
            {title: "Address", field: "address", width: 150, headerFilter: "input", headerFilterPlaceholder: " "},
